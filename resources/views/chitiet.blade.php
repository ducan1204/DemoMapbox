...
" width="174px" height="54px;" title="Thongtin.land"></a>
        ...
        <div class="row" style="padding-top: 0px">
            ...
            <div class="col-sm-6">
                ...
                <!-- <div class="row">
                    ...
                    <div class="col-sm-9">
                        <a href="/quy-hoach/{a.mbtiles}">Bản đồ a</a>
                        <p>Xã Hòa Long, TP. Bà Rịa, BR-VT</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-3"><img width="100%" alt="" src="/images/36528386.jpg"></div>
                    <div class="col-sm-9">
                        <a href="/quy-hoach/{dc eakao 17.mbtiles}">Bản đồ dc eakao 17</a>
                        <p>Phường Phước Hiệp, TP. Bà Rịa, BR-VT</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-3"><img width="100%" alt="" src="/images/36528386.jpg"></div>
                    <div class="col-sm-9">
                        <a href="/quy-hoach/{DC32_20.mbtiles}">Bản đồ DC32_20</a>
                        <p>Xã Long Phước, TP. Bà Rịa, BR-VT</p>
                    </div>
                </div> -->
            </div>
    ...
    <script>
        ...
        var map = new mapboxgl.Map({
            ...
            style: 'mapbox://styles/leducan/{{$style}}', // stylesheet location
